...
export const SLIDES = [
  ...
  },
  {
    ...
    bullets: [
      ...
      { label: 'RAG / retrieved docs', desc: 'Any retrieved content you pre-pended for this turn' },
  ...
  },
  {
    ...
    body: 'If attention were infinite, you could dump everything and let the model sort it out. It is not infinite. Softmax guarantees the sum across all positions is exactly 1. Every piece of context you add dilutes the share available to every other piece.',
  ...
  },
  {
    ...
    instructions: 'Add pieces of context of different types and sizes. Watch the budget redistribute. Try to keep "attention per critical token" above 5%.',
  },
  {
    id: 'two-levers',
    type: 'text',
