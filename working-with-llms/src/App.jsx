...
const SLIDES = [
  ...
  },
  {
    ...
    body: "We gave the same task to our mock LLM twice: once with 'Build me a task management API with real-time updates' (vague), and once with the Dense Architecture Specification produced by the agent (dense). We ran each 5 times and measured hallucination surface, output consistency, dimension resolution, and code quality.",
    keyTakeaway: "This isn't theoretical. The comparative data you're about to see was generated by the test suite running the full pipeline.",
  },
  {
    id: "comparison-demo",
    type: "component",
...
function TextSlide({ slide }) {
  return (
    <div style={{ maxWidth: 900, margin: "0 auto", padding: "60px 40px" }}>
      ...
      {slide.subtitle && (
        <p style={{ fontSize: 20, color: C.accent, marginBottom: 32,
          fontFamily: "'IBM Plex Sans', sans-serif" }}>
          {slide.subtitle}
        </p>
      )}
      {slide.body && (
        <p style={{ fontSize: 18, lineHeight: 1.7, color: C.textDim, marginBottom: 32,
          fontFamily: "'IBM Plex Sans', sans-serif" }}>
          {slide.body}
        </p>
      )}
      ...
      {slide.keyTakeaway && (
        <div style={{ background: C.accentGlow, border: `1px solid ${C.accent}33`,
          ...
          <p style={{ fontSize: 15, color: C.accent, margin: 0, lineHeight: 1.6,
            fontFamily: "'IBM Plex Sans', sans-serif" }}>
